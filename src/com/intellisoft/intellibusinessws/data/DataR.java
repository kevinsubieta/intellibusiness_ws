...
abstract public class DataR<T> extends Wrapper<T> {

	private static final Logger Log = Logger.getLogger(DataR.class);
	
	protected Connection connection;
	private Statement statement = null;
	private ResultSet result = null;

	public DataR(Class<T> type, Connection connection) {
